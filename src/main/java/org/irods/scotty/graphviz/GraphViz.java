...
public StreamedContent getStreamedContent(String dot_source, String type)
{
   byte[] img_stream = getGraph(dot_source, type);
   
   StreamedContent graphic = new DefaultStreamedContent(new ByteArrayInputStream(img_stream));
